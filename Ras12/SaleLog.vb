...
Public Class SaleLog
    ...
    Private Sub LoadGridPending()
        ...
        Me.TxtPost.Text = ""
    End Sub
    Public Function CreatePointmentItem(pSubj As String, pLocation As String, pStartDate As Date, pEndDate As Date, Optional pBody As String = "", Optional pRequireAttendees As String = "") As Boolean
    ...
    Private Sub LoadGridCust()
        Dim strSQL As String = "select RecID, CustShortName, CustAddress from Customerlist" _
            & " where recid >0  and City='" & myStaff.City _
            & "' And recid in (select CustID from cust_Detail where status+CAT='OKChannel' and VAL='" _
            & Me.CmbCustType.Text & "')"
