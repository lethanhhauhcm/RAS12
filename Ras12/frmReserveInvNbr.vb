...
Public Class frmReserveInvNbr
    ...
    Private Sub ME_INV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadCmb_MSC(Me.CmbAL, "INV_AL")
        If Now.Month = 1 And Now.Day < 15 Then
    ...
    Private Sub LoadInv()
        ...
        End If
        strSQL = String.Format("Select RecID, INVNo, Status,  Amount, Currency, ROE, CustShortName, CustFullName, " &
    ...
    Private Function SaveInv(blnReserveInvNbrOnly As Boolean, blnEditOnly As Boolean) As Boolean
        ...
        Try
            ...
            cmd.CommandText = UpdateLogFile("INV", "ReservedINV", INVID, Me.TxtNoiDung.Text, strSaveType, "", "")
            cmd.ExecuteNonQuery()
