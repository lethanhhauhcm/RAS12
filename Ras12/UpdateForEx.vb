...
Public Class UpdateForEx
    ...
    Private Sub CmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdAdd.Click
        ...
        'If TxtApplyROE_COS.Text.Trim = "" Then Exit Sub
        'Dim cmd_CGO As SqlClient.SqlCommand = CGOConn.CreateCommand
        '    Try
        '        If CGOConn.State <> ConnectionState.Open Then CGOConn.Open()
        '    cmd_CGO.CommandText = "Insert into ForEx (Currency, BSR, BBR, EffectDate" _
        '            & ", SurCharge, ApplyROEto, ApplySCto, City, FstUser)" &
        '            " values ('" & Me.CmbCurr.Text & "','" & CDec(Me.txtBSR.Text) & "','" & CDec(Me.txtBBR.Text) & "','" &
        '            Me.txtEffectDate.Value & "','" & CDec(Me.txtSurcharge.Text) & "','" & Me.TxtApplyROE_COS.Text & "','" &
        '            Me.txtApplySCto.Text & "','" & myStaff.City _
        '            & "','" & myStaff.SICode & "')"
