...
Public Class clsE_Invoice
    ...
    Public Function ConvertResponseCode2Desc(strFunctionName As String, strResponseCode As String) As String
        ...
        Select Case strFunctionName
            ...
            Case FunctionName.getHashInv, FunctionName.getHashInvWithToken, FunctionName.publishInvWithToken, FunctionName.CancelInvoiceWithToken, FunctionName.GetHashInvNoticeErrors
                Select Case strResponseCode
                    Case "ERR:1"
                        strDesc = "Tài khoản đăng nhập sai hoặc không có quyền"
                    Case "ERR:21"
            ...
            Case FunctionName.ReplaceWithoutInv
                Select Case strResponseCode
                    ...
                    Case Else
                        strDesc = strResponseCode
                End Select
            Case FunctionName.SendInvNoticeErrors, FunctionName.SendInvNoticeErrorsWidthToken
                Select Case strResponseCode
                    Case "ERR:1"
                        strDesc = "Tài khoản đăng nhập sai hoặc không có quyền"
                    Case "ERR:3"
    ...
    Public Function getInvViewNoPay(strPortalServiceUrl As String _
        ...
        strSoapBody = objRequest.ToString
        mstrLastRequest = strSoapBody
        If My.Computer.Name = "5-247" AndAlso pblnLogXml = False Then
            If MsgBox("LogXML?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then pblnLogXml = True
        End If
    ...
    Public Function SendAgainEmailServ(strPublishServiceUrl As String _
        ...
        mstrLastRequest = strSoapBody
        If pblnLogXml Then
            Append2TextFile("E_InvLog:" & strPublishServiceUrl & vbNewLine _
                                & "Request:" & vbNewLine & ReformatXml(mstrLastRequest))
        End If
        objHttp.send(strSoapBody)
        mstrLastResponse = objHttp.responseText
    ...
    End Function
    Public Function SendInvNoticeErrorsWidthToken(strWsUrl As String _
                        , strWsUser As String, strWsPass As String _
                        , strStaffAccount As String, strStaffPass As String, strPattern As String _
                        , strHash As String, strSerialCert As String) As Boolean

        Dim objHttp As New MSXML2.XMLHTTP60
        Dim strSoapBody As String
        Dim objRequest2 As XElement

        Dim objSign As XElement = <CKS>
                                      <SerialCert><%= strSerialCert %></SerialCert>
                                      <Base64Hash><%= strHash %></Base64Hash>
                                      <SignValue><%= SignHashVNPT(strHash, strSerialCert) %></SignValue>
                                  </CKS>
        ...
        ResetProperties(FunctionName.SendInvNoticeErrorsWidthToken)

        objRequest2 = <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://www.w3.org/2003/05/soap-envelope">
                          <soap:Body>
                              <SendInvNoticeErrorsWidthToken xmlns="http://tempuri.org/">
                                  <Account><%= strStaffAccount %></Account>
                                  <ACpass><%= strStaffPass %></ACpass>
                                  <xml><%= objSign.ToString %></xml>
                                  <username><%= strWsUser %></username>
                                  <password><%= strWsPass %></password>
                              </SendInvNoticeErrorsWidthToken>
                          </soap:Body>
                      </soap:Envelope>
        '<pattern><%= strPattern %></pattern>
        '<AttachFile>10</AttachFile>
        ...
        objHttp.setRequestHeader("Content-Type", "text/xml; charset=utf-8")
        objHttp.setRequestHeader("Content-Length", "length")
        objHttp.setRequestHeader("SOAPAction", "http://tempuri.org/SendInvNoticeErrorsWidthToken")
        ...
        mstrReponseCode = GetWsResponse(mobjXmlDoc, "SendInvNoticeErrorsWidthTokenResponse")

        ConvertResponseCode2Desc(FunctionName.SendInvNoticeErrorsWidthToken, mstrReponseCode)
        If mstrReponseCode.StartsWith("ERR:") Then
            If Not pblnLogXml Then
                Append2TextFile("E_InvLog:" & strWsUrl & vbNewLine & "Request:" & vbNewLine & ReformatXml(mstrLastRequest))
                Append2TextFile("Response:" & vbNewLine & ReformatXml(mstrLastResponse))
    ...
    Public Function GetHashInvNoticeErrors(strWsUrl As String _
                        , strWsUser As String, strWsPass As String _
                        , strStaffAccount As String, strStaffPass As String, strPattern As String _
                        , strSerialCert As String, objInvXml As XElement) As Boolean
        ...
        ResetProperties(FunctionName.GetHashInvNoticeErrors)

        objRequest2 = <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://www.w3.org/2003/05/soap-envelope">
                          <soap:Body>
                              <GetHashInvNoticeErrors xmlns="http://tempuri.org/">
                                  <Account><%= strStaffAccount %></Account>
                                  <ACpass><%= strStaffPass %></ACpass>
                                  <xml><%= objInvXml.ToString %></xml>
                                  <username><%= strWsUser %></username>
                                  <password><%= strWsPass %></password>
                                  <pattern><%= strPattern %></pattern>
                                  <convert>0</convert>
                              </GetHashInvNoticeErrors>
                          </soap:Body>
                      </soap:Envelope>
        '<pattern><%= strPattern %></pattern>
        '<AttachFile>10</AttachFile>
        ...
        objHttp.setRequestHeader("Content-Type", "text/xml; charset=utf-8")
        objHttp.setRequestHeader("Content-Length", "length")
        objHttp.setRequestHeader("SOAPAction", "http://tempuri.org/GetHashInvNoticeErrors")
        ...
        mstrReponseCode = GetWsResponse(mobjXmlDoc, "GetHashInvNoticeErrorsResponse")

        ConvertResponseCode2Desc(FunctionName.GetHashInvNoticeErrors, mstrReponseCode)
        If Not mstrReponseCode.StartsWith("ERR:") Then
            Dim objInvToken As New clsInvToken
            Return True
        Else
            If Not pblnLogXml Then
                Append2TextFile("E_InvLog:" & strWsUrl & vbNewLine & "Request:" & vbNewLine & ReformatXml(mstrLastRequest))
    ...
    Public Function GetCertInfo(strWsUrl As String _
        ...
        ConvertResponseCode2Desc(FunctionName.getHashInv, Base64ToString(mstrReponseCode))
        If Not mstrReponseCode.StartsWith("ERR:") Then
    ...
    Public Function getHashInv(strWsUrl As String _
                        , strWsUser As String, strWsPass As String _
                        , strStaffAccount As String, strStaffPass As String _
                        , strSerialCert As String, strFkey As String, strPattern As String) As clsInvToken
        ...
        If Not mstrReponseCode.StartsWith("ERR:") Then
            Dim objInvToken As New clsInvToken
            mobjXmlDoc.LoadXml(mstrReponseCode)
            objInvToken.KeyInv = GetWsResponse(mobjXmlDoc, "key")
            objInvToken.IdInv = GetWsResponse(mobjXmlDoc, "idInv")
            objInvToken.HashValue = GetWsResponse(mobjXmlDoc, "hashValue")
            objInvToken.SignValue = SignHashVNPT(objInvToken.HashValue, strSerialCert)
            Return objInvToken
        Else
            Return Nothing
        End If
    ...
    Public Function getHashInvWithToken(strWsUrl As String _
                        , strWsUser As String, strWsPass As String _
                        , strStaffAccount As String, strStaffPass As String _
                        , strSerialCert As String, intInvType As Integer _
                        , strToken As String, strPattern As String, strSerial As String _
                        , strCustId As String, strCustFullName As String _
                        , strAddress As String, strPhone As String _
                        , strTaxCode As String, strFOP As String _
                        , strInvoiceKey As String, strKindOfService As String _
                        , intKindOfInvoice As Integer, lstProducts As List(Of clsProduct) _
                        , Optional strBuyer As String = "", Optional strEmail As String = "") As clsInvToken
        ...
        objXElement = CreateInvData(strCustId, strCustFullName _
                        , strAddress, strPhone, strTaxCode, strFOP, strInvoiceKey, strKindOfService _
                        , intKindOfInvoice, lstProducts _
                        , strPattern, strSerial, 0, 0, strBuyer, strEmail)
        ...
        If pblnLogXml Then
            Append2TextFile("E_InvLog:" & strWsUrl & vbNewLine & "Request:" _
                            & vbNewLine & ReformatXml(mstrLastRequest))
        End If
    ...
    Public Function publishInvWithToken(strWsUrl As String _
                        , strWsUser As String, strWsPass As String _
                        , strStaffAccount As String, strStaffPass As String _
                        , strSerialCert As String, objInvToken As clsInvToken _
                        , Optional strPattern As String = "", Optional strSerial As String = "") As Boolean
        ...
        If My.Computer.Name = "5-247" AndAlso Not pblnLogXml Then
            If pblnLogXml AndAlso MsgBox("LogXML?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                pblnLogXml = True
            End If
        End If
        ...
        objXElement =
            <Invoices>
                <SerialCert><%= strSerialCert %></SerialCert>
                <Inv>
                    <key><%= objInvToken.KeyInv %></key>
                    <idInv><%= objInvToken.IdInv %></idInv>
                    <signValue><%= objInvToken.SignValue %></signValue>
                </Inv>
            </Invoices>
    ...
    Public Function AdjustReplaceInvWithToken(strWsUrl As String _
                        , strWsUser As String, strWsPass As String _
                        , strStaffAccount As String, strStaffPass As String _
                        , strSerialCert As String _
                        , strOldPattern As String, strOldSerial As String, strOldInvNo As String _
                        , objInvToken As clsInvToken) As Boolean
        ...
        objXElement = <Invoices>
                          <SerialCert><%= strSerialCert %></SerialCert>
                          <PatternOld><%= strOldPattern %></PatternOld>
                          <SerialOld><%= strOldSerial %></SerialOld>
        ...
        ResetProperties(FunctionName.AdjustReplaceInvWithToken)
        ...
        objHttp.setRequestHeader("Content-Type", "text/xml; charset=utf-8")
        objHttp.setRequestHeader("Content-Length", "length")
        objHttp.setRequestHeader("SOAPAction", "http://tempuri.org/AdjustReplaceInvWithToken")
        ...
        mstrReponseCode = GetWsResponse(mobjXmlDoc, "AdjustReplaceInvWithTokenResponse")
    ...
    Public Function ImportAndPublishInv(strWsUrl As String _
        ...
        Else
            If Not pblnLogXml Then
                Append2TextFile("E_InvLog:" & strWsUrl & vbNewLine _
                                & "Request:" & vbNewLine & ReformatXml(mstrLastRequest))
                Append2TextFile("Response:" & vbNewLine & ReformatXml(mstrLastResponse))
            End If
            Return False
