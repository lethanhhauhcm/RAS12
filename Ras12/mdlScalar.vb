Module MdlScalar
    ...
    Public Function ScalarToDate(ByVal pTbl As String, ByVal pField As String, ByVal pDK_Order As String) As Date
        ...
        Return KQ
    End Function
    Public Function ChangeStatus_ByID(ByVal pTable As String, ByVal pNewStatus As String, ByVal PID As Integer, Optional ByVal pALStatus As String = "") As String
        Dim KQ As String
        KQ = "update " & pTable & " set LstUser='" & myStaff.SICode & "', Lstupdate=cast(getdate() as smalldatetime), status='" & pNewStatus & "'"
        If pALStatus <> "" Then
