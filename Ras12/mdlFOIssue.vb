Module MdlFOIssue
    ...
    Public Function VeCongNoDaInv(ByVal pTRXID As Integer) As Boolean
        ...
        Return KQ
    End Function
    Public Function CreditCardCharged(ByVal intRcpId As Integer) As Boolean
        Dim intOldFopId As Integer
        intOldFopId = ScalarToInt("FOP", "RecID", "RCPID=" & intRcpId & " and status ='OK' and FOP='CRD'" _
                & " And RMK like '%BOSwipeCRD%'")
        If intOldFopId > 0 Then
            Return True
        Else
            Return False
        End If
    ...
    Public Sub ClearInput2(ByVal parFOissueTKT As FOissueTKT)
        ...
        parFOissueTKT.txtItinerary.Text = ""
    ...
    Public Sub PrepareForOptSRV(ByVal parFOissueTKT As FOissueTKT)
        ...
        parFOissueTKT.txtItinerary.Enabled = True
