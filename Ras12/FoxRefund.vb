Public Class FoxRefund
    Private Sub FoxRefund_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSQL = "Select CustID, CustShortName, DOI, TKNO, PaxName, Itinerary " &
            " from tkT_1A t inner join customerlist c on t.custid=c.recid" _
            & " where c.City='" & myStaff.City _
            & "' and srv in ('R','V') and left(tkno,3)='738' and custid in (select CustID from cc_Setting)" &
