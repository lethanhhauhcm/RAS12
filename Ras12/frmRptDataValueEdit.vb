Public Class frmRptDataValueEdit
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtDescription.Text = "" Then
            ...
            Exit Sub
        End If
        arrInserts(0) = "Insert into RAS12.DBO.RptDataValues (DataType,CustId,DataCode,Value" _
                    & ",Description,FstUser) values ('" & mstrDataType _
                    & "'," & mintCustId & ",'" & mstrDataCode _
                    & "',N'" & txtValue.Text & "','" & txtDescription.Text _
                    & "','" & myStaff.SICode & "')"
        If txtRecID.Text <> "" Then
            Array.Resize(arrInserts, 2)
            arrInserts(1) = "Update RAS12.DBO.RptDataValues set Status='XX'" _
