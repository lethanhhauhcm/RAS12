Public Class ExportToTSP
    ...
    Private StrDK_TKT As String = " qty<>0 and Status ='OK' and DocType='ETK'" _
                & " And (left(TKNO,1)='Z' or dof >'" _
                & MaxDOF & "' or (left(TKNO,1)<>'Z' and Srv='R')) "
    ...
    Private Sub GridTC_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles GridTC.CellContentClick
        ...
        StrDK = StrDK & " and fstuser in (Select Val from MISC where cat='User2TSP' and Status='ok' and City='" & myStaff.City & "')"
