Public Class Payment4VCR
    ...
    Private Sub GridFOP_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GridFOP.CellEnter
        ...
        ElseIf e.ColumnIndex = 2 Then
            ...
            varROE = IIf(varCurr = "VND", 1, ForEX_12(myStaff.City, Now.Date, varCurr, "BSR", "YY"))
    ...
    Private Sub LblSearch_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LblSearch.LinkClicked
        ...
        For i As Int16 = 0 To Me.GrdVCRinPrj.RowCount - 1
            tmpROE = IIf(Me.GrdVCRinPrj.Item(2, i).Value = "VND", 1, ForEX_12(myStaff.City, Now.Date, Me.GrdVCRinPrj.Item(2, i).Value, "BSR", "YY"))
        ...
        Try
            For r As Int16 = 0 To Me.GridFOP.RowCount - 1
                If Me.GridFOP.Item("Amount", r).Value > 0 Or Me.GridFOP.Item("FOP", r).Value = "RND" Then
                    Dim strDocument As String = String.Empty
                    If GridFOP.Item("Document", r).Value IsNot Nothing Then
                        strDocument = GridFOP.Item("Document", r).Value.ToString.Replace("--", "")
                    End If
                    StrSQL = "insert FLX_FOP (OrderID, FOP, Curr, Amount, ROE, Document, pmtID, Payer, status, FstUser) values (-99,'" &
                    Me.GridFOP.Item("FOP", r).Value & "','" &
                    Me.GridFOP.Item("Currency", r).Value & "','" &
                    Me.GridFOP.Item("Amount", r).Value & "','" &
                    Me.GridFOP.Item("ROE", r).Value & "','" & strDocument & "','" &
                    pmtID & "',N'[VCR]:" & Me.TxtPayer.Text.Replace("--", "") & "/" &
                        IIf(Me.OptPrj.Checked, Me.CmbPrj.Text, Me.CmbVCRNo.Text) & "','" &
            ...
            For i As Int16 = 0 To Me.GrdVCRinPrj.RowCount - 1
                cmd.CommandText = cmd.CommandText & ";" _
                    & ChangeStatus_ByID("DiscountVCR", "OK", Me.GrdVCRinPrj.Item(0, i).Value)
