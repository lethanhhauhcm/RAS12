Public Class frmRequireDataValuesList
    ...
    Public Function Search() As Boolean
        ...
        strMsQuerry = "Select Recid,Value,Description" _
                        & " from GO_RequiredDataValues" _
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim frmRqData As New frmRequiredDataValueEdit(mintCustId, mstrDataCode, mstrDataType)
        frmRqData.ShowDialog()
        Search()
    End Sub

    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        Dim frmRqData As New frmRequiredDataValueEdit(mintCustId, mstrDataCode, mstrDataType _
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Dim strQuerry As String = "Update GO_RequiredDataValues set Status='XX' where Recid=" _
